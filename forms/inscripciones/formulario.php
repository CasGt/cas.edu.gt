...
// Generar un token de protección si no está ya creado
if (empty($_SESSION['form_token'])) {
    $_SESSION['form_token'] = bin2hex(random_bytes(32));
}
$tipo_alumno = $_SESSION['tipo_alumno'];

$year = date("Y") + 1;
// Conexión a la base de datos
require './conexion.php';

if ($tipo_alumno == "reingreso") {
    $sql = "SELECT 
...
FROM alumno
INNER JOIN historial_medico ON alumno.codigo_alumno = historial_medico.codigo_alumno
INNER JOIN madre ON alumno.codigo_alumno = madre.codigo_alumno
INNER JOIN padre ON alumno.codigo_alumno = padre.codigo_alumno
INNER JOIN terceros ON alumno.codigo_alumno = terceros.codigo_alumno
WHERE alumno.codigo_alumno = ?";
    ...
    $stmt->bind_result(
        ...
        $medicamento_diario,
        $vacuna1_SI_alumno,
        $nombre_vacuna1_alumno,
        $vacuna2_SI_alumno,
        $nombre_vacuna2_alumno,
        $tuberculosis,
        $polivalente,
        $polio,
        $hepatitis_b,
        ...
        $nacionalidad_padre,
        $vacuna1_SI_padre,
        $nombre_vacuna1_padre,
        $vacuna2_SI_padre,
        $nombre_vacuna2_padre,
        $profesion_padre,
        $departamento_padre,
        $municipio_padre,
        $direccion_padre,
        ...
        $terceros1_retiran_alumno,
        $terceros1_retiran_alumno_parentesco,
        $terceros1_retiran_alumno_telefono,
        $terceros2_retiran_alumno,
        $terceros2_retiran_alumno_parentesco,
        $terceros2_retiran_alumno_telefono
    );
    ...
    if ($stmt->fetch()) {
        $alumno = [
            ...
            'carnet' => $carnet,
            'familiar_vive' => $familiar_vive,
            'nacimiento_alumno' => $nacimiento_alumno,
            ...
            'medicamento_diario' => $medicamento_diario,
            'vacuna1_SI_alumno' => $vacuna1_SI_alumno,
            'nombre_vacuna1_alumno' => $nombre_vacuna1_alumno,
            'vacuna2_SI_alumno' => $vacuna2_SI_alumno,
            'nombre_vacuna2_alumno' => $nombre_vacuna2_alumno,
            ...
            'varicela' => $varicela,
            'gripe_viral' => $gripe_viral,
            'papiloma' => $papiloma,
            'paperas' => $paperas,
            'fiebre_tifoidea' => $fiebre_tifoidea,
            'rubeola' => $rubeola,
            'sarampion' => $sarampion,
            'rotavirus' => $rotavirus,
            ...
            'sal_andrews' => $sal_andrews,
            'alka_seltzer' => $alka_seltzer,
            'bromexina' => $bromexina,
            'cofal_fuerte' => $cofal_fuerte,
            'gencloben' => $gencloben,
            ...
            'alka_d' => $alka_d,
            'otik' => $otik,
            'sulfacetamida' => $sulfacetamida,
            'ranitidina' => $ranitidina,
            'suero_oral' => $suero_oral,
            'trilox_antiasido' => $trilox_antiasido,
            'tabcin' => $tabcin,
            'pasta_lasar' => $pasta_lasar,
            'nombres_madre' => $nombres_madre,
            'apellidos_madre' => $apellidos_madre,
            'dpi_madre' => $dpi_madre,
            'nit_madre' => $nit_madre,
            'estado_civil_madre' => $estado_civil_madre,
            'nacionalidad_madre' => $nacionalidad_madre,
            'vacuna1_SI_madre' => $vacuna1_SI_madre,
            'nombre_vacuna1_madre' => $nombre_vacuna1_madre,
            'vacuna2_SI_madre' => $vacuna2_SI_madre,
            'nombre_vacuna2_madre' => $nombre_vacuna2_madre,
            'profesion_madre' => $profesion_madre,
            'departamento_madre' => $departamento_madre,
            'municipio_madre' => $municipio_madre,
            'direccion_madre' => $direccion_madre,
            'telefonocasa_madre' => $telefonocasa_madre,
            'celular_madre' => $celular_madre,
            'correo_madre' => $correo_madre,
            'empresalabora_madre' => $empresalabora_madre,
            'cargoenepresa_madre' => $cargoenepresa_madre,
            'departamentoempresa_madre' => $departamentoempresa_madre,
            'municipio_empresa_madre' => $municipio_empresa_madre,
            'direccion_empresa_madre' => $direccion_empresa_madre,
            ...
            'dpi_padre' => $dpi_padre,
            'nit_padre' => $nit_padre,
            'estado_civil_padre' => $estado_civil_padre,
            'nacionalidad_padre' => $nacionalidad_padre,
            'vacuna1_SI_padre' => $vacuna1_SI_padre,
            'nombre_vacuna1_padre' => $nombre_vacuna1_padre,
            'vacuna2_SI_padre' => $vacuna2_SI_padre,
            'nombre_vacuna2_padre' => $nombre_vacuna2_padre,
            'profesion_padre' => $profesion_padre,
            'departamento_padre' => $departamento_padre,
            'municipio_padre' => $municipio_padre,
            'direccion_padre' => $direccion_padre,
            'telefonocasa_padre' => $telefonocasa_padre,
            'celular_padre' => $celular_padre,
            'correo_padre' => $correo_padre,
            'empresalabora_padre' => $empresalabora_padre,
            'cargoenepresa_padre' => $cargoenepresa_padre,
            'departamentoempresa_padre' => $departamentoempresa_padre,
            'municipio_empresa_padre' => $municipio_empresa_padre,
            'direccion_empresa_padre' => $direccion_empresa_padre,
            'telefono_empresa_padre' => $telefono_empresa_padre,
            'correo_empresa_padre' => $correo_empresa_padre,
            'terceros1_retiran_alumno' => $terceros1_retiran_alumno,
            'terceros1_retiran_alumno_parentesco' => $terceros1_retiran_alumno_parentesco,
            'terceros1_retiran_alumno_telefono' => $terceros1_retiran_alumno_telefono,
            'terceros2_retiran_alumno' => $terceros2_retiran_alumno,
            'terceros2_retiran_alumno_parentesco' => $terceros2_retiran_alumno_parentesco,
            'terceros2_retiran_alumno_telefono' => $terceros2_retiran_alumno_telefono
        ];
    } else {
    ...
    $sql = "SELECT nombres_alumno, apellidos_alumno, correo_alumno 
...
<body class="bg-gray-100 p-8">
        ...
        <form id="admissionForm" action="guardar_datos.php" method="POST" class="space-y-6">
            ...
            <div id="section2" class="section hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="nombres_padre" name="nombres_padre" placeholder="Ej. Juan, Carlos..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="apellidos_padre" class="block font-medium">Apellidos (*)</label>
                        <input type="text" id="apellidos_padre" name="apellidos_padre" placeholder="Ej. Pérez, García..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="dpi_padre" class="block font-medium">D.P.I. (*)</label>
                        <input type="number" id="dpi_padre" name="dpi_padre" placeholder=" Ej.  1234567890101" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="nit_padre" class="block font-medium">NIT</label>
                        <input type="text" id="nit_padre" name="nit_padre" placeholder="Ej. 1234567-8" class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nacionalidad_padre" name="nacionalidad_padre" placeholder="Ej.  Guatemalteca, Mexicana..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="departamento_padre" name="departamento_padre" placeholder="Ej. Escuintla, Guatemala..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="municipio_padre" class="block font-medium">Municipio (*)</label>
                        <input type="text" id="municipio_padre" name="municipio_padre" placeholder="Ej. Siquinalá, Antigua..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div class="col-span-2">
                        <label for="direccion_padre" class="block font-medium">Dirección (*)</label>
                        <input type="text" id="direccion_padre" name="direccion_padre" placeholder="Ej. 445 Mount Eden Road, Mazatenango..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" id="celular_padre" name="celular_padre" placeholder="Ej. Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999" required>
                    </div>
                    <div class="col-span-2">
                        <label for="correo_personal_padre" class="block font-medium">Correo Personal (*)</label>
                        <input type="email" id="correo_personal_padre" name="correo_personal_padre" placeholder="Ej. myname@servidor.com" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="profesion_padre" name="profesion_padre" placeholder="Ej. Ingeniero, Contador..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" id="nombre_empresa_padre" name="nombre_empresa_padre" placeholder="Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999">
                    </div>
                    <div>
                        <label for="telefono_empresa_padre" class="block font-medium">Teléfono de la empresa</label>
                        <input type="number" id="telefono_empresa_padre" name="telefono_empresa_padre" placeholder="Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999">
                    </div>
                    <div>
            ...
            <div id="section3" class="section hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="nombres_madre" name="nombres_madre" placeholder="Ej. Juanita, Sofía..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="apellidos_madre" class="block font-medium">Apellidos (*)</label>
                        <input type="text" id="apellidos_madre" name="apellidos_madre" placeholder="Ej. Pérez, García..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="dpi_madre" class="block font-medium">D.P.I. (*)</label>
                        <input type="number" id="dpi_madre" name="dpi_madre" placeholder=" Ej. 1234567890101" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="nit_madre" class="block font-medium">NIT</label>
                        <input type="text" id="nit_madre" name="nit_madre" placeholder="Ej. 1234567-8" class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nacionalidad_madre" name="nacionalidad_madre" placeholder="Ej. Guatemalteca, Mexicana..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="departamento_madre" name="departamento_madre" placeholder="Ej. Escuintla, Guatemala..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="municipio_madre" class="block font-medium">Municipio (*)</label>
                        <input type="text" id="municipio_madre" name="municipio_madre" placeholder="Ej. Siquinalá, Antigua..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div class="col-span-2">
                        <label for="direccion_madre" class="block font-medium">Dirección (*)</label>
                        <input type="text" id="direccion_madre" name="direccion_madre" placeholder="Ej. 445 Mount Eden Road, Mazatenango..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="telefonocasa_madre" class="block font-medium">Teléfono (*)</label>
                        <input type="number" id="telefonocasa_madre" name="telefonocasa_madre" placeholder="Ej. Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999" >
                    </div>
                    <div>
                        <label for="celular_madre" class="block font-medium">Celular (*)</label>
                        <input type="number" id="celular_madre" name="celular_madre" placeholder="Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999" required>
                    </div>
                    <div class="col-span-2">
                        <label for="correo_madre" class="block font-medium">Correo Personal (*)</label>
                        <input type="email" id="correo_madre" name="correo_madre" placeholder="Ej. myname@servidor.com" class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="profesion_madre" name="profesion_madre" placeholder="Ej. Ingeniera, Contadora..." class="mt-1 block w-full p-2 border border-gray-300 rounded" required>
                    </div>
                    <div>
                        <label for="cargoenepresa_madre" class="block font-medium">Puesto que labora</label>
                        <input type="text" id="cargoenepresa_madre" name="cargoenepresa_madre" placeholder="Ej. Gerente, Supervisora..." class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div class="col-span-2">
                        <label for="empresalabora_madre" class="block font-medium">Nombre de la empresa</label>
                        <input type="text" id="empresalabora_madre" name="empresalabora_madre" placeholder="Ej. Industrias XYZ..." class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div>
                        <label for="telefono_empresa_madre" class="block font-medium">Teléfono de la empresa</label>
                        <input type="number" id="Ingrese un número de 8 dígitos sin espacio" name="telefono_empresa_madre" placeholder="Ej. 23240000" class="mt-1 block w-full p-2 border border-gray-300 rounded" max="99999999">
                    </div>
                    <div>
                        <label for="departamentoempresa_madre" class="block font-medium">Departamento</label>
                        <input type="text" id="departamentoempresa_madre" name="departamentoempresa_madre" placeholder="Ej. Tecnología, Ventas..." class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div>
                        <label for="municipio_empresa_madre" class="block font-medium">Municipio</label>
                        <input type="text" id="municipio_empresa_madre" name="municipio_empresa_madre" placeholder="Ej. Guatemala, Antigua..." class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div class="col-span-2">
                        <label for="direccion_empresa_madre" class="block font-medium">Dirección exacta de la empresa</label>
                        <input type="text" id="direccion_empresa_madre" name="direccion_empresa_madre" placeholder="Ej. 5ta avenida zona 10, Guatemala..." class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                    <div class="col-span-2">
                        <label for="correo_empresa_madre" class="block font-medium">Correo Corporativo</label>
                        <input type="email" id="correo_empresa_madre" name="correo_empresa_madre" placeholder="Ej. corporativo@empresa.com" class="mt-1 block w-full p-2 border border-gray-300 rounded">
                    </div>
                </div>
            </div>
            ...
            <div id="section4" class="section hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="autorizo_retirar1_telefono" name="autorizo_retirar1_telefono" placeholder="Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border rounded" max="99999999" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="autorizo_retirar2_telefono" name="autorizo_retirar2_telefono" placeholder="Ingrese un número de 8 dígitos sin espacio" class="mt-1 block w-full p-2 border  rounded" max="99999999" required>
                    </div>
                </div>
            ...
            <div id="section5" class="section hidden">
                <div class="text-center">
                    ...
                    <p>
                        <a href="#" id="openTermsModal" class="text-blue-600 hover:underline" target="_blank">Leer Términos y Condiciones</a>
                    </p>
    ...
    <script>
        ...
        const totalSections = 5; // Asegúrate de que este número sea igual al número de secciones que tienes
        ...
        document.getElementById('nextBtn').addEventListener('click', () => {
            ...
            currentSectionFields.forEach(field => {
                if (!field.value) {
                    isValid = false;
                    field.classList.add('border-red-500'); // Marca el campo en rojo si está vacío
                } else {
                    field.classList.remove('border-red-500'); // Remueve la marca roja si el campo está lleno
                }
            });
            ...
            if (isValid) {
                if (currentSection < totalSections) {
                    ...
                    document.getElementById('admissionForm').submit(); // Envía el formulario si es la última sección
                }
            } else {
        ...
        if ($tipo_alumno == "reingreso") {
            function cargarDatosAlumno() {
                if (alumnoData) {
                    ...
                    document.getElementById('apellidos_alumno').value = alumnoData.apellidos_alumno || '';
                    document.getElementById('correo_alumno').value = alumnoData.correo_alumno || '';
                    document.getElementById('carnet').value = alumnoData.carnet || '';
                    document.getElementById('familiar_vive').value = alumnoData.familiar_vive || '';
                    document.getElementById('nacimiento_alumno').value = alumnoData.nacimiento_alumno || '';
                    document.getElementById('grado_alumno').value = alumnoData.grado_alumno || '';
                    document.getElementById('nombres_padre').value = alumnoData.nombres_padre || '';
                    document.getElementById('apellidos_padre').value = alumnoData.apellidos_padre || '';
                    document.getElementById('dpi_padre').value = alumnoData.dpi_padre || '';
                    document.getElementById('nit_padre').value = alumnoData.nit_padre || '';
                    document.getElementById('estado_civil_padre').value = alumnoData.estado_civil_padre || '';
                    document.getElementById('nacionalidad_padre').value = alumnoData.nacionalidad_padre || '';
                    document.getElementById('departamento_padre').value = alumnoData.departamento_padre || '';
                    document.getElementById('municipio_padre').value = alumnoData.municipio_padre || '';
                    document.getElementById('direccion_padre').value = alumnoData.direccion_padre || '';
                    document.getElementById('telefono_padre').value = alumnoData.telefono_padre || '';
                    document.getElementById('celular_padre').value = alumnoData.celular_padre || '';
                    document.getElementById('correo_personal_padre').value = alumnoData.correo_personal_padre || '';
                    document.getElementById('profesion_padre').value = alumnoData.profesion_padre || '';
                    document.getElementById('puesto_trabajo_padre').value = alumnoData.puesto_trabajo_padre || '';
                    document.getElementById('nombre_empresa_padre').value = alumnoData.nombre_empresa_padre || '';
                    document.getElementById('telefono_empresa_padre').value = alumnoData.telefono_empresa_padre || '';
                    document.getElementById('departamento_empresa_padre').value = alumnoData.departamento_empresa_padre || '';
                    document.getElementById('municipio_empresa_padre').value = alumnoData.municipio_empresa_padre || '';
                    document.getElementById('direccion_exacta_empresa_padre').value = alumnoData.direccion_exacta_empresa_padre || '';
                    document.getElementById('correo_corporativo_padre').value = alumnoData.correo_corporativo_padre || '';
                    document.getElementById('nombres_madre').value = alumnoData.nombres_madre || '';
                    document.getElementById('apellidos_madre').value = alumnoData.apellidos_madre || '';
                    document.getElementById('dpi_madre').value = alumnoData.dpi_madre || '';
                    document.getElementById('nit_madre').value = alumnoData.nit_madre || '';
                    document.getElementById('estado_civil_madre').value = alumnoData.estado_civil_madre || '';
                    document.getElementById('nacionalidad_madre').value = alumnoData.nacionalidad_madre || '';
                    document.getElementById('departamento_madre').value = alumnoData.departamento_madre || '';
                    document.getElementById('municipio_madre').value = alumnoData.municipio_madre || '';
                    document.getElementById('direccion_madre').value = alumnoData.direccion_madre || '';
                    document.getElementById('telefonocasa_madre').value = alumnoData.telefonocasa_madre || '';
                    document.getElementById('celular_madre').value = alumnoData.celular_madre || '';
                    document.getElementById('correo_madre').value = alumnoData.correo_madre || '';
                    document.getElementById('profesion_madre').value = alumnoData.profesion_madre || '';
                    document.getElementById('cargoenepresa_madre').value = alumnoData.cargoenepresa_madre || '';
                    document.getElementById('empresalabora_madre').value = alumnoData.empresalabora_madre || '';
                    document.getElementById('telefono_empresa_madre').value = alumnoData.telefono_empresa_madre || '';
                    document.getElementById('departamentoempresa_madre').value = alumnoData.departamentoempresa_madre || '';
                    document.getElementById('municipio_empresa_madre').value = alumnoData.municipio_empresa_madre || '';
                    document.getElementById('direccion_empresa_madre').value = alumnoData.direccion_empresa_madre || '';
                    document.getElementById('correo_empresa_madre').value = alumnoData.correo_empresa_madre || '';
                    document.getElementById('actividades_estudiante').value = alumnoData.actividades_estudiante || '';
                    document.getElementById('enfermedades_estudiante').value = alumnoData.enfermedades_estudiante || '';
                    document.getElementById('medicamentos_diario').value = alumnoData.medicamentos_diario || '';
                    document.getElementById('alergias_estudiante').value = alumnoData.alergias_estudiante || '';
                    document.getElementById('evaluacion_estudiante').value = alumnoData.evaluacion_estudiante || '';
                    document.getElementById('intervencion_estudiante').value = alumnoData.intervencion_estudiante || '';

                    // Autorizaciones médicas
                    document.getElementById('acetaminofen').checked = alumnoData.acetaminofen === '1';
                    document.getElementById('diclofenaco').checked = alumnoData.diclofenaco === '1';
                    document.getElementById('aspirina').checked = alumnoData.aspirina === '1';
                    document.getElementById('peptobismol').checked = alumnoData.peptobismol === '1';
                    document.getElementById('fastum').checked = alumnoData.fastum === '1';
                    document.getElementById('ibuprofeno').checked = alumnoData.ibuprofeno === '1';
                    document.getElementById('bromexina').checked = alumnoData.bromexina === '1';
                    document.getElementById('loperamida').checked = alumnoData.loperamida === '1';
                    document.getElementById('ranitidina').checked = alumnoData.ranitidina === '1';
                    document.getElementById('tabcin').checked = alumnoData.tabcin === '1';
                    document.getElementById('cataflan').checked = alumnoData.cataflan === '1';
                    document.getElementById('irs').checked = alumnoData.irs === '1';
                    document.getElementById('cloprin').checked = alumnoData.cloprin === '1';
                    document.getElementById('certal').checked = alumnoData.certal === '1';
                    document.getElementById('piralvex').checked = alumnoData.piralvex === '1';
                    document.getElementById('otomidil').checked = alumnoData.otomidil === '1';
                    document.getElementById('alfersurf').checked = alumnoData.alfersurf === '1';
                    document.getElementById('histaprin').checked = alumnoData.histaprin === '1';
                    document.getElementById('loratadina').checked = alumnoData.loratadina === '1';
                    document.getElementById('hidrocortisona').checked = alumnoData.hidrocortisona === '1';
                    document.getElementById('sal_andrews').checked = alumnoData.sal_andrews === '1';
                    document.getElementById('alka_seltzer').checked = alumnoData.alka_seltzer === '1';
                    document.getElementById('cofal_fuerte').checked = alumnoData.cofal_fuerte === '1';
                    document.getElementById('gencloben').checked = alumnoData.gencloben === '1';
                    document.getElementById('nauseol').checked = alumnoData.nauseol === '1';
                    document.getElementById('nistatina').checked = alumnoData.nistatina === '1';
                    document.getElementById('alka_d').checked = alumnoData.alka_d === '1';
                    document.getElementById('otik').checked = alumnoData.otik === '1';
                    document.getElementById('sulfacetamida').checked = alumnoData.sulfacetamida === '1';
                    document.getElementById('suero_oral').checked = alumnoData.suero_oral === '1';
                    document.getElementById('trilox_antiasido').checked = alumnoData.trilox_antiasido === '1';
                    document.getElementById('pasta_lasar').checked = alumnoData.pasta_lasar === '1';
                    document.getElementById('autorizo_retirar1_nombre').value = alumnoData.autorizo_retirar1_nombre || '';
                    document.getElementById('autorizo_retirar1_parentesco').value = alumnoData.autorizo_retirar1_parentesco || '';
                    document.getElementById('autorizo_retirar1_telefono').value = alumnoData.autorizo_retirar1_telefono || '';
                    document.getElementById('autorizo_retirar2_nombre').value = alumnoData.autorizo_retirar2_nombre || '';
                    document.getElementById('autorizo_retirar2_parentesco').value = alumnoData.autorizo_retirar2_parentesco || '';
                    document.getElementById('autorizo_retirar2_telefono').value = alumnoData.autorizo_retirar2_telefono || '';

                    document.getElementById('tipo_transporte').value = alumnoData.tipo_transporte || '';
                }
            }
